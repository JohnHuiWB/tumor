...
def train(model, batch_size=8, samples_per_epoch=500, epochs=16):  #8,2000,5
    # history = History()
...
def continue_train(filename,batch_size=4, samples_per_epoch=200, epochs=3):
